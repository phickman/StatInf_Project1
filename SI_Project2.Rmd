...
The tests for the null hypothesis assumes there is no difference between the supplement types or dosage levels.
...
The null hypothesis that there is no difference can be rejected in each case.  The higher the dose the greater the tooth length.
